...
library(car)
#read in datasets
A_Bayes <- read.csv("datasets/A_Bayes.csv")
A_Cat <- read.csv("datasets/A_Cat.csv")
A_Neighbors <- read.csv("datasets/A_Neighbors.csv")
A_NN <- read.csv("datasets/A_NN.csv")
A_RF <- read.csv("datasets/A_RF.csv")
M_Bayes <- read.csv("datasets/M_Bayes.csv")
M_Cat <- read.csv("datasets/M_Cat.csv")
M_Neighbors <- read.csv("datasets/M_Neighbors.csv")
M_NN <- read.csv("datasets/M_NN.csv")
M_RF <- read.csv("datasets/M_RF.csv")
PC_Bayes <- read.csv("datasets/PC_Bayes.csv")
PC_Cat <- read.csv("datasets/PC_Cat.csv")
PC_Neighbors <- read.csv("datasets/PC_Neighbors.csv")
PC_NN <- read.csv("datasets/PC_NN.csv")
PC_RF <- read.csv("datasets/PC_RF.csv")
#means
